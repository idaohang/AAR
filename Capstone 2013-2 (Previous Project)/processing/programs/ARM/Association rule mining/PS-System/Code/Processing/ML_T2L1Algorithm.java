...
public class ML_T2L1Algorithm{
	...
	private ArrayList candidates, frequent, frequent1, fCounters, fSupport, fTransList;
	 ...
	 */
	public ML_T2L1Algorithm(BuildFrequentItemsets owner){
		bfi = owner;
